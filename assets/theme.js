...
$(document).ready(function(){
  ...
  $(".donation-price").html( '$' + $("#number_filters a.selected").attr('id') );
  $(".donation-price").digits();
  $(".donation-price").removeClass("hidden");
  setTimeout(function(){
    $("#Quantity").val($("#number_filters a.selected").attr('id'));
  }, 1000)
  
  $("#Quantity").removeClass("should-show");

  // js for tabs
  $('.custom-recharge-wrapper #tabs li a:not(:first)').addClass('inactive');
  $('.custom-recharge-wrapper .container').addClass("hidden");
  $('.custom-recharge-wrapper .container:first').removeClass("hidden");
  ...
  $('.custom-recharge-wrapper #tabs li a').click(function(){
    ...
    var t = $(this).attr('id');    
    $('#' + t + "C #number_filters a").removeClass('selected');
    $('#' + t + "C #number_filters a").eq(1).addClass('selected');
    $(".donation-price").html( '$' + $('#' + t + "C #number_filters a").eq(1).attr('id') );
    $(".donation-price").digits();
    $(".donation-price").removeClass("hidden");
    $("#Quantity").val($("#number_filters a.selected").attr('id'));
    $("#Quantity").removeClass("should-show");
    $(".subscription-product-form").removeClass( "custom-tab2C");
    $(".subscription-product-form").removeClass( "custom-tab1C");
    
    $('button[data-add-to-cart]').text("Donate");

    $('#' + t + "C #number_filters a").each(function(){
      if( $(this).hasClass('selected')){
        $("#Quantity").val($(this).attr('id'));
      }      
    })
    
    
    if($(this).hasClass('inactive')){
      $('.custom-recharge-wrapper #tabs li a').addClass('inactive');           
      $(this).removeClass('inactive');

      $('.custom-recharge-wrapper .container').addClass("hidden");      
      $('.custom-recharge-wrapper #'+ t + 'C').removeClass("hidden");
      $(".subscription-product-form").addClass( t + "C");
    }
  });
  //   end tabs js
  
//   $(".one-time-wrapper .quantity-for-actual")
//   $("#Quantity").val($("#number_filters a.selected").attr('id'));
  
  $("#number_filters a").click(function() {
    $(this).parent().find(".quantity-for-actual").removeClass("should-show");
    $(this).parent().find(".custom").removeClass("hidden");
    $("#Quantity").val($(this).attr('id') );
    $('#number_filters a').not(this).removeClass('selected');
    $(".product-single__quantity").addClass("invisible");
    $(".donation-price").removeClass("hidden");
    $(".donation-price").html( '$' + $(this).attr('id') ).digits();
    $(".donation-price").digits();
  ...
  $(".custom").click(function() {
    $(".donation-price").addClass("hidden");
    $(this).addClass("hidden");
    $(this).parent().find(".quantity-for-actual").addClass("should-show");    
    $(this).parent().find(".quantity-for-actual").focus();
  });
  
  $(".quantity-for-actual").keyup(function(){
